...
#. Run the setup script to create the Docker-based cross-compilation environment.
   ...
   #. For Windows, **open a Docker Desktop terminal** (PowerShell) and run:
      ...
      .. code-block:: powershell
         ...
         .\setup_rdk_docker.ps1 rcarv4h

   The setup script performs the following tasks:

   - checks if the current script is the latest version by comparing it with the remote version on GitHub; if not, it prompts you to download the latest version.
...
#. Select your container name (default: ``ros2_cross_build_container``) from the list of running containers.
